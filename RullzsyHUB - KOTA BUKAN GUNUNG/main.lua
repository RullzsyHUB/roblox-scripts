...
local Window = Rayfield:CreateWindow({
   Name = "RullzsyHUB | KOTA BUKAN GUNUNG",
   Icon = "braces",
...
local jsonFolder = mainFolder .. "/js_mount_kota_bukan_gunung"
...
local baseURL = "https://raw.githubusercontent.com/RullzsyHUB/roblox-scripts-json/refs/heads/main/json_kota_bukan_gunung/"
local jsonFiles = {
    "checkpoint_1.json",
	"checkpoint_2.json",
	"checkpoint_3.json",
