...
local function performAntiAFKAction()
    pcall(function()
        -- Method 1: VirtualUser Input
        VirtualUser:CaptureController()
        VirtualUser:ClickButton2(Vector2.new())

        -- Method 2: Small movement
        if character and character:FindFirstChild("HumanoidRootPart") then
            ...
            character.HumanoidRootPart.CFrame = currentPos + randomOffset
        end
        LastActionTime = tick()
    end)
end
...
local AntiAFKToggle = BypassTab:CreateToggle({
   ...
   Callback = function(Value)
       ...
       if Value then
           ...
           Rayfield:Notify({
               Title = "Bypass AFK",
               Content = "Anti-AFK telah dimatikan.",
               Duration = 3,
               Image = "x"
           })
       end
...
local function startManualAutoWalkSequence(startCheckpoint)
    ...
    local function playNext()
        ...
        if currentCheckpoint > #jsonFiles then
            -- All checkpoints completed
            if loopingEnabled then
                -- Loop kembali dari (checkpoint 1)
                Rayfield:Notify({
...
TeleportTab:CreateButton({
   ...
   Callback = function()
      ManualTeleport(-663.50, 59.50, -444.30, "Checkpoint 1")
   end,
})
...
TeleportTab:CreateButton({
   ...
   Callback = function()
      ManualTeleport(-45.82, 43.49, -554.29, "Checkpoint 2")
   end,
})
...
TeleportTab:CreateButton({
   ...
   Callback = function()
      ManualTeleport(835.20, 67.50, -426.53, "Checkpoint 3")
   end,
})
...
TeleportTab:CreateButton({
   ...
   Callback = function()
      ManualTeleport(1013.21, 72.10, -109.71, "Checkpoint 4")
   end,
})
...
TeleportTab:CreateButton({
   ...
   Callback = function()
      ManualTeleport(2089.09, 71.49, -147.08, "Checkpoint 5")
   end,
})
...
TeleportTab:CreateButton({
   ...
   Callback = function()
      ManualTeleport(2330.66, 63.71, -139.48, "Checkpoint 6")
   end,
})
...
TeleportTab:CreateButton({
   ...
   Callback = function()
      ManualTeleport(2548.74, 43.36, -413.92, "Checkpoint 7")
   end,
})
...
TeleportTab:CreateButton({
   ...
   Callback = function()
      ManualTeleport(2683.04, 87.57, -335.49, "Checkpoint 8")
   end,
})
...
TeleportTab:CreateButton({
   ...
   Callback = function()
      ManualTeleport(2714.11, 159.69, -362.31, "Checkpoint 9")
   end,
})
...
TeleportTab:CreateButton({
   ...
   Callback = function()
      ManualTeleport(3037.41, 155.49, -366.57, "Checkpoint 10")
   end,
})
...
TeleportTab:CreateButton({
   ...
   Callback = function()
      ManualTeleport( 3228.60, -4.36, -338.06, "Checkpoint 11")
   end,
})
...
TeleportTab:CreateButton({
   ...
   Callback = function()
      ManualTeleport(3668.87, 23.63, -220.89, "Checkpoint 12")
   end,
})
...
TeleportTab:CreateButton({
   ...
   Callback = function()
      ManualTeleport(3725.59, 91.50, -247.96, "Checkpoint 13")
   end,
})
...
TeleportTab:CreateButton({
   ...
   Callback = function()
      ManualTeleport(3966.75, 67.71, -307.92, "Checkpoint 14")
   end,
})
-------------------------------------------------------------
-- TELEPORT - END
