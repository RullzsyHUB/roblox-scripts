...
local Window = Rayfield:CreateWindow({
   Name = "RullzsyHUB | MOUNT KAWAH EXPEDITION",
   Icon = "braces",
...
local jsonFolder = mainFolder .. "/js_mount_kawah_expedition"
...
local baseURL = "https://raw.githubusercontent.com/RullzsyHUB/roblox-scripts-json/refs/heads/main/json_mount_kawah_expedition/"
local jsonFiles = {
    "spawnpoint.json",
    "checkpoint_1.json",
	"checkpoint_2.json",
