...
local Window = Rayfield:CreateWindow({
   Name = "RullzsyHUB | MOUNT YAHAYUK EVENT V2",
   Icon = "braces",
...
local jsonFolder = mainFolder .. "/js_mount_yahayuk_event_v2"
...
local baseURL = "https://raw.githubusercontent.com/RullzsyHUB/roblox-scripts-json/refs/heads/main/json_mount_yahayuk_event_v2/"
local jsonFiles = {
    "ontosummit.json",
}
